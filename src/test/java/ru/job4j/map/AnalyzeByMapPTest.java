...
public class AnalyzeByMapPTest {
    @Test
    public void whenAverageScore() {
        double average = AnalyzeByMapP.averageScore(
                List.of(
                        new PupilL("Ivanov",
                                List.of(
    ...
    public void whenListOfPupilAverage() {
        List<Label> average = AnalyzeByMapP.averageScoreByPupil(
                List.of(
                        new PupilL("Ivanov",
                                List.of(
                                        new Subject("Math", 100),
    ...
    public void whenListOfSubjectAverage() {
        List<Label> average = AnalyzeByMapP.averageScoreBySubject(
                List.of(
                        new PupilL("Ivanov",
                                List.of(
                                        new Subject("Math", 70),
    ...
    public void whenBestPupil() {
        Label best = AnalyzeByMapP.bestStudent(
                List.of(
                        new PupilL("Ivanov",
                                List.of(
                                        new Subject("Math", 100),
    ...
    public void whenBestSubject() {
        Label best = AnalyzeByMapP.bestSubject(
                List.of(
                        new PupilL("Ivanov",
                                List.of(
                                        new Subject("Math", 100),
